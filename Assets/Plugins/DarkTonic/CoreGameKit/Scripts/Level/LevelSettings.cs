...
#region Public Static Methods
        ...
        public static WavePrefabPool GetFirstMatchingPrefabPool(string poolName) {
            ...
            var oChild = poolsHolder.Find(poolName);
...
#region Public Properties
        ...
        public static List<Transform> GetAllSpawners {
            get {
                var spawnContainer = Instance.transform.Find(SpawnerContainerTransName);
...
#region Private properties
        ...
        private static Transform GetPoolsHolder {
            get {
                ...
                return lev.transform.Find(PrefabPoolsContainerTransName);
            }
        }
        ...
        private static Transform GetWorldVariablesHolder {
            get {
                ...
                return lev.transform.Find(WorldVariablesContainerTransName);
            }
        }
        /*! \endcond */
