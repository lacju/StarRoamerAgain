...
[Tooltip("Get total number of a pooled item set up in Pool Boss in Core GameKit, spawned and despawned copies")]
public class CoreGameKitPoolBossItemTotalCount : FsmStateAction {
