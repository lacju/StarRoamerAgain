...
public class LevelSettingsInspector : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        var playerStatsHolder = _settings.transform.Find(LevelSettings.WorldVariablesContainerTransName);
        ...
        var poolingHolder = _settings.transform.Find(LevelSettings.KillerPoolingContainerTransName);
    ...
    private void CreateSpawner() {
        ...
        var spawnersHolder = _settings.transform.Find(LevelSettings.SpawnerContainerTransName);
    ...
    private void CreatePrefabPool() {
        ...
        var poolsHolder = _settings.transform.Find(LevelSettings.PrefabPoolsContainerTransName);
        if (poolsHolder == null) {
        ...
        var dupe = poolsHolder.Find(newPrefabPoolName);
        if (dupe != null) {
