...
public class Radar : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        _radarCenterTexture = new Texture2D(centerBlipSize, centerBlipSize, TextureFormat.RGB24, false);
        _radarBlip1Texture = new Texture2D(blip1Size, blip1Size, TextureFormat.RGB24, false);
        _radarBlip2Texture = new Texture2D(blip2Size, blip2Size, TextureFormat.RGB24, false);
        _radarBlip3Texture = new Texture2D(blip3Size, blip3Size, TextureFormat.RGB24, false);
        _radarBlip4Texture = new Texture2D(blip4Size, blip4Size, TextureFormat.RGB24, false);
